...
<head>
  ...
  <meta name="description" content="Ncet Monster Minds Online Compiler provides free e-learnig platform for coders to compile there code online in C, C++, Java, Python language.">
  <meta name="keywords" content="Ncet monster minds ,Ncet monster minds compiler, ncet coding club ,ncet coding club compiler, ncet compiler, ncetmonsterminds, ncet monsterminds, ncet coding club, ncet online compiler, monsterminds online compiler, Nagarjuna College of Engineering and Technology, Bangalore,ncetmonsterminds.com,ncet cse.co.in,ncet.co.in, free, C compiler ,java compiler, python compiler, c++ compiler,free compiler,  ">
  <meta name="generator" content="ncetmonsterminds">
  
  <!--====== Title ======-->
  <title>Ncet Monster Minds | ONLINE COMPILER</title>
          ...
          <div class="page-banner-cont">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Ncet Monster Minds Online Compiler</li>
              </ol>
            </nav>
...
$(document).ready(function(){
    ...
    $(window).on('load', function() {
        $("form").submit(function(event){
            ...
            $.post("compile.php", formValues, function(data){
