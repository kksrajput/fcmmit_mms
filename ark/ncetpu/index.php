...
<form class="form-horizontal" action="login.php?q=index.php" method="POST">
    ...
    <p style="text-size:30px;">For forget password and technical problems <br>call:- 8094113042 / 9113536073 / 8210313031</p>
...
<p>
    <span style="color:lightyellow">For forget password and technical problems<br></span>
    <span style="color:lightyellow"><br></span>
    <span style="color:lightyellow">call:- 8094113042 / 9113536073 / 8210313031<br></span>
    <hr>
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		     ...
		     <h4 style="font-size:12px" >For forget password and technical problems</h4>
		     <h4 style="font-size:12px "></h4>
		     <h4 style="font-size:12px ">call:- 8094113042 / 9113536073 / 8210313031</h4>
		 </div>
		 </div>
