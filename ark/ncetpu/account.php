...
if (@$_GET['q'] == 1) {
    ...
    echo '<div class="panel"  style=" margin-left: 0px; margin-right: 0px; padding-left: 0px; padding-right: 0px; overflow-x: scroll;"> <center><h4 style="color:red;"><strong>Please Refresh the Page at 10 : AM and Click on Start button to start the exam<strong></h4></center>
            <table class="table table-striped title1"  style="vertical-align:middle;table-layout: fixed;">
            <tr>
                <td style="vertical-align:middle;padding-left:2px;"><b>S.N.</b></td>
                <td style="vertical-align:middle;padding-left:0px;"><b>Name</b></td>
                <td style="vertical-align:middle;padding-left:0px;"><b>Total ques</b></td>
                <td style="vertical-align:middle;padding-left:0px;"><b>Correct Answer</b></td>
                <td style="vertical-align:middle;padding-left:0px;"><b>Wrong Answer</b></td>
                <td style="vertical-align:middle;padding-left:0px;"><b>Total Marks</b></td>
                <td style="vertical-align:middle;padding-left:0px;"><b>Time limit</b></td>
                <td style="vertical-align:middle;padding-left:0px;"><b>Action</b></td></tr>';
    $c = 1;
    while ($row = mysqli_fetch_array($result)) {
        ...
        if ($rowcount == 0) {
            echo '<tr><td style="vertical-align:middle;padding-left:2px;">' . $c++ . '</td>
                  <td style="vertical-align:middle;padding-left:1px;">' . $title . '</td>
                  <td style="vertical-align:middle;padding-left:1px;">' . $total . '</td>
                  <td style="vertical-align:middle;padding-left:1px;">+' . $correct . '</td>
                  <td style="vertical-align:middle;padding-left:1px;">-' . $wrong . '</td>
                  <td style="vertical-align:middle;padding-left:1px;">' . $correct * $total . '</td>
                  <td style="vertical-align:middle;padding-left:1px;">' . $time . '&nbsp;min</td>
                  <td style="vertical-align:middle;padding-left:1px;"><b><a href="account.php?q=quiz&step=2&eid=' . $eid . '&n=1&t=' . $total . '&start=start" id="start_btn" class="btn" style="color:#FFFFFF;background:darkgreen;font-size:12px;padding:7px;padding-left:10px;padding-right:10px"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>&nbsp;<span id="start_btn_status"><b>Start Now</b></span></a></b></td></tr>';
...
document.getElementById("start_btn").style.cursor="default";
document.getElementById("start_btn").style.background="#f62459";


document.getElementById("start_btn_status").innerHTML="Start At : <br>"+start_at+" AM"
...
*/
  ...
  <td style="vertical-align:middle"><b><a href="account.php?q=quiz&step=2&eid=' . $eid . '&n=1&t=' . $total . '&start=start" class="btn" style="margin:0px;background:darkorange;color:white">&nbsp;<span class="title1"><b>Continue</b></span></a></b></td></tr>';
                ...
                echo '<tr style="color:darkgreen">
                <td style="vertical-align:middle">' . $c++ . '</td>
                <td style="vertical-align:middle;padding-left:0px;">' . $title . '&nbsp;<span title="This quiz is already solve by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td>
                <td style="vertical-align:middle">' . $total . '</td><td style="vertical-align:middle">+' . $correct . '</td>
                <td style="vertical-align:middle">-' . $wrong . '</td><td style="vertical-align:middle">' . $correct * $total . '</td>
                <td style="vertical-align:middle">' . $time . '&nbsp;min</td>        </tr>';
            }
        }
    }
    
    // time . '&nbsp;min</td> <td style="vertical-align:middle"><b> <a href="account.php?q=result&eid=' . $eid . '" class="btn" style="margin:0px;background:darkred;color:white">&nbsp;<span class="title1"><b>View Result</b></span></a> </b></td>    </tr>';
    ...
    <div class="panel" style="padding-top:1px;;word-wrap:break-word">
            <h3 align="center" style="font-family:calibri;color:#4f4fdd;"><strong>:General Instructions:</strong></h3>
            <br />
            <p align="justify">
    <ul>
        <li>
            <p align="justify"><b>You are allowed to start the test whenever you want to. The timer would start only when you start the test. It is recommended to start the test at the prescribed time.</b></p>  
        </li>
        <br>
        <li>
            <p align="justify"><b>To start the test, click on <span style="color:red;"> Start </span></b></p>
        </li>
        <br>
        <li>
            <p align="justify"><b>Once the test is started the timer would run irrespective of your logged in or logged out status. So it is <span style="color:red;"> recommended not to logout before test completion.</span></b></p>
        </li>
        <br>
        <li>
            <p align="justify"><b>To mark an answer you need to select it and press the <span style="color:red;">SAVE</span> button</b></p>
        </li>
        <br>
        <li>
            <p align="justify"><b>Upon locking, the selected answer would be displayed and the question will be marked <span style="color:green;">" GREEN "</span> .Use the navigation buttons to navigate through different questions.</b></p>
        </li>
        <br>

        <li>
            <p align="justify"><b>Use the navigation buttons to navigate through different questions.</b></p>
        </li>
        <br>
        <li>
            <p align="justify"><b>The marks for correct and incorrect answer are listed above in the table. <span style="color:red;"> 0 marks </span> would be awarded for the questions that are "not marked" <span style="color:red;"> (having "red" status). </span></b></p>        
        </li>
        <br>        
        <li>
            <p align="justify"><b>If you get some error, you can contact us via <a href=feedback.php>this form</a>.</b></p>
        </li>
...
function end(){
  data = prompt("Are you sure to end this Quiz? Type \\"yes\\" in the textbox below and press enter");
  if(data=="yes"){
...
var countdownTimer = setInterval(\'secondPassed()\', 1000);
            ...
            <br><br><font size="3" style="margin-left:10px;font-family:\'typo\' font-size:20px; font-weight:bold;color:darkred">Important! : PRESS <span style="color:blue;" >"SAVE"</span> BUTTON AFTER SELECTING ANY OPTION. <span style="color:blue;" >"EVERY TIME"</span>BEFORE PROCEEDING TO <span style="color:blue;" >"NEXT QUESTION"</span> </font>';
            ...
            while ($row = mysqli_fetch_array($q)) {
                ...
                <div style="background-color:white">
                    <div style="font-size:20px;font-weight:bold;font-family:calibri;margin:10px">' . $sn . ' : <p>' . $qns . '</p>
...
<br />';
            ...
            if (strlen($ans) > 0) {
                echo "<font style=\"color:blue;font-size:12px;font-weight:bold\">Your Selected answer: </font><font style=\"color:#565252;font-size:12px;\">" . $ans . "</font>&nbsp;&nbsp;<a href=update.php?q=quiz&step=2&eid=$eid&n=$sn&t=$total&qid=$qid&delanswer=delanswer><span class=\" \" style=\"font-size:12px;color:darkblue\">Click to Cancel your Answer</span></a><br /><br />";
            }
            ...
            while ($row = mysqli_fetch_array($q)) {
                ...
                echo '<div class="funkyradio-success"><input type="radio" id="' . $optionid . '" name="ans" value="' . $optionid . '" onclick="enable()"> <label for="' . $optionid . '" style="width:100%"><div style="color:black;font-size:12px;word-wrap:break-word;padding-left:40px;">' . $option . '</div></label></div>';
            }
            echo '</div>';
            if ($_GET["t"] > $_GET["n"] && $_GET["n"] != 1) {
                echo '<br /><a href="account.php?q=quiz&step=2&eid=' . $eid . '&n=' . ($sn - 1) . '&t=' . $total . '" class="btn btn-primary" style="height:30px"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"  style="font-size:12px"></span></a>&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-default" disabled="true" id="sbutton" style="height:30px"><span class="glyphicon glyphicon-lock" style="font-size:12px" aria-hidden="true"></span><font style="font-size:12px;font-weight:bold"> SAVE</font></button>&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-default" onclick="frmreset()" style="height:30px"></span><font style="font-size:12px;font-weight:bold">Reset</font></button>&nbsp;&nbsp;&nbsp;&nbsp;<a href="account.php?q=quiz&step=2&eid=' . $eid . '&n=' . ($sn + 1) . '&t=' . $total . '" class="btn btn-primary" style="height:30px"><span class="glyphicon glyphicon-arrow-right" aria-hidden="true"  style="font-size:12px"></span></a></form><br><br>';
            ...
            echo '<br><br><font size="3" style="margin-left:0px;font-family:\'typo\' font-size:20px; font-weight:bold;color:darkred">Important! :AFTER <span style="color:blue;" >"SAVE"</span>check color of ur sumited question No. is Changed to <span style="color:darkblue;" >"BLUE"</span> in bottom Table </font></div>';
            
            echo '<div class="panel" style="text-align:center;overflow-x: scroll;  width=100%; ">
...
<tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Quiz</b></td><td style="vertical-align:middle"><b>Total Questions</b></td><td style="vertical-align:middle"><b>Right</b></td><td style="vertical-align:middle"><b>Wrong<b></td><td style="vertical-align:middle"><b>Unattempted<b></td><td style="vertical-align:middle"><b>Score</b></td><td style="vertical-align:middle"><b>Action<b></td></tr>';
    ...
    while ($row = mysqli_fetch_array($q)) {
        ...
        $c++;
        echo '<tr><td style="vertical-align:middle">' . $c . '</td><td style="vertical-align:middle">' . $title . '</td><td style="vertical-align:middle">' . $total . '</td><td style="vertical-align:middle">' . $r . '</td><td style="vertical-align:middle">' . $w . '</td><td style="vertical-align:middle">' . ($total - $r - $w) . '</td><td style="vertical-align:middle">' . $s . '</td>              </tr>';
    }
    echo '</table></div>';
}

//style="vertical-align:middle">' . $s . '</td> <td style="vertical-align:middle"><b>  <a href="account.php?q=result&eid=' . $eid . '" class="btn" style="margin:0px;background:darkred;color:white">&nbsp;<span class="title1"><b>View Result</b></td>  </tr>';
...
<a href="#" data-toggle="modal" data-target="#developers" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">Organized by NGI</a>
</div>
