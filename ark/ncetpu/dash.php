...
if (@$_GET['q'] == 0) {
    ...
    echo '<div class="panel" style="text-align:center;overflow-x: scroll;  "><table class="table table-striped title1"  style="vertical-align:middle">
...
if (@$_GET['q'] == 2) {
    ...
    echo '<div class="panel title" style="text-align:center;overflow-x: scroll;  width=100%; ">
...
<tr><td style="vertical-align:middle"><b>Rank</b></td><td style="vertical-align:middle"><b>Name</b></td><td style="vertical-align:middle"><b>Branch</b></td><td style="vertical-align:middle"><b>Username</b></td><td style="vertical-align:middle"><b>Roll number</b></td><td style="vertical-align:middle"><b>Gender</b></td><td style="vertical-align:middle"><b>Score</b></td></tr>';
    ...
    echo '</table></div>';
    echo '<div class="panel title" style="text-align:center;overflow-x: scroll;  width=100%; "><table class="table table-striped title1" ><tr>';
...
if (@$_GET['q'] == 1) {
    ...
    echo '<div class="panel" style="text-align:center;overflow-x: scroll;  width=100%; "><table class="table table-striped title1">
