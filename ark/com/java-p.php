...
<head>
    ...
    <!--====== Title ======-->
    <title>NCET MONSTER MINDS | Run-Java </title>
          ...
          <?php
                ...
                //$input=$r4['tc'];
                    ...
                    if(trim($error)=="")
                    {
                        ...
                        echo "<div class=\"row\"><div class=\"col-sm-5\"></div><div class=\"col-sm-5\"><div class=\"alert alert-success\"> <strong>Successfully Compiled!</strong> Click Below Submit Button To Submit -1.</div></div><div class=\"col-sm-2\"></div></div><br>";
                    }
                    else if(!strpos($error,"error"))
                    {
                        ...
                        echo "<div class=\"row\"><div class=\"col-sm-5\"></div><div class=\"col-sm-5\"><div class=\"alert alert-success\"> <strong>Successfully Compiled!</strong> Click Below Submit Button To Submit -2.</div></div><div class=\"col-sm-2\"></div></div><br>";
                    }
                    else
                    {
                        echo "<pre>$error</pre>";
                ...
                //                         <input type=\"hidden\" name=\"il\" value=\"$tle\">
                //                         <textarea  name=\"result\" rows=\"10\" cols=\"10\">$output</textarea>
                            ...
                            <div class=\"col-sm-5\">
                                    <form action=\"allsubmission-p.php\" method=\"POST\">
                                        ...
                                        <div class=\"row\">
            							    <div class=\"col-lg-6\">
            							        <h5>Your Output</h5>
            							        <textarea  name=\"result\" rows=\"15\" cols=\"20\" readonly>$output</textarea><br>
            							    </div>
            							    <div class=\"col-lg-6\">
            							        <h5>expected output</h5>
            							        <textarea  name=\"result\" rows=\"15\" cols=\"20\" readonly>$ac</textarea><br>
            							    </div>
            							</div>
                                        <input class=\"main-btn tm\" type=\"submit\" value=\"Submit Code\"> 
                                        </div></div>";
                ...
                else if($_POST['src'])
                {
                   ...
                   echo "<div class=\"row\">
                            <div class=\"col-sm-4\">
                                    ...
                                    <form action=\"contestsubmission-p.php\" method=\"POST\">
                                    <input type=\"hidden\" name=\"pb\" value=\"$pb\">
                                    <input type=\"hidden\" name=\"id\" value=\"$pid\">
                                    <input type=\"hidden\" name=\"mid\" value=\"$nid\">
                                    <input type=\"hidden\" name=\"vd\" value=\"$fr\">
