          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="page-banner-cont">
                <h2>Show Submitted Code</h2>
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="../../index.html">Home</a></li>
                    <li class="breadcrumb-item active" aria-current="page"><a href="home-p.php">Portal</a></li>
                    <li class="breadcrumb-item active" aria-current="page"><a href="allsubmission-p.php?name=<?php echo("$username"); ?>">Sumbissions</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Show Code</li>
                  </ol>
                </nav>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-12 mb-30 white-bg pb-50" id="3">
          <div class="section-title pb-50">
            ...
            <h2 style="text-align:center;">Show Code</h2>
          </div>
          ...
          <?php
                ...
                {
                    echo("<h5>Submit Id: $row[id]</h5><br><br>

                        <textarea id='div' class=\"form-control\" rows=\"20\" cols=\"10\">$row[source_code]</textarea>");
                }
