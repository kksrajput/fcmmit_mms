              ...
              <div class="page-banner-cont">
                ...
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Create Contest Problem</li>
                  </ol>
                </nav>
        ...
        <div class="col-lg-10">
            <div class="contact-from" style="box-shadow: 0 8px 8px 0 rgba(0, 0, 0, 0.5), 0 6px 20px 0 rgba(0, 0, 0, 0)">
                ...
                <div class="form-group">
                    ...
                    <label for="ta"><b>Enter Your Contest ID</b></label>
                    <input type="text" name="ci" class="form-control"><br>

                    <label for="ta"><b>Enter Your Contest Name</b></label>
                    <input type="text" name="cn" class="form-control"><br>

                    <label for="ta"><b>Enter Problem Name</b></label>
                    <input type="text" name="pb" class="form-control"><br>

                    <label for="in"><b>Enter Problem Description</b></label>
                    <textarea name="c1" class="form-control" rows="15" cols="80"></textarea><br>
                    ...
                    <input type="text" name="tll" title="Only float is allowed (Ex:3.00)" placeholder="1.00" class="form-control"><br>

                    <b>Enter Test Cases</b><br>
                    <textarea class="form-control" name="c3" rows="10" cols="80"></textarea><br>

                    <b>Enter Output Of Test Cases</b><br>
                    <textarea class="form-control" name="c4" rows="10" cols="80"></textarea><br>
