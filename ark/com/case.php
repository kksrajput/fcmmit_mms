...
while($row=mysqli_fetch_array($sts))
{
	...
	echo "<div style=\"margin-left:300px; margin-right:200px; padding-left:200px;border-bottom:1px solid black;\"> <a href=\"showcode-p.php?id=$row[sid]&nm=$row[sname]\">$row[sid]</a>.......<a href=\"profile-p.php?user=$row[sname]\">$row[sname]</a>---------$row[verdict]</div>";
}
