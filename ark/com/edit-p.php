...
$(document).ready(function(){
    ...
    $(window).on('load', function() {
        $("form").submit(function(event){
            ...
            $.post("update-p.php", formValues, function(data){
